...
```python title="read_keyboard.py" collapsed
import sys
import keyboard
...
```python title="simulate_keystrokes.py" collapsed
import sys
import time
...
![video](https://r2.rex.wf/blog/parabox/intro-levels.mp4?v=2)
...
![video](https://r2.rex.wf/blog/parabox/parabox.mp4?v=2)
...
![video](https://r2.rex.wf/blog/parabox/impossible-overflow.mp4?v=2)

So, we just need the last move to be one that we can reach. Below is a showcase of the level, along with the debugger.

![video](https://r2.rex.wf/blog/parabox/impossible-solve.mp4?v=2)
...
![video](https://r2.rex.wf/blog/parabox/small.mp4?v=2)
...
![video](https://r2.rex.wf/blog/parabox/missing-attempt.mp4?v=2)
...
![video](https://r2.rex.wf/blog/parabox/missing-reset-bug.mp4?v=2)
...
![video](https://r2.rex.wf/blog/parabox/missing-solve.mp4?v=2)
...
![video](https://r2.rex.wf/blog/parabox/last-hurdle.mp4?v=2)
...
![video](https://r2.rex.wf/blog/parabox/full-showcase.mp4?v=2)
