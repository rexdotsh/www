...
export const mockFleet = (now = Date.now()): Fleet => ({
  ...
  services: [
    ...
    },
    {
      id: "vaultwarden",
      name: "vaultwarden",
      blurb: "passwords, self-hosted so nobody else holds them",
      who: "family",
      host: "arrakis",
      health: "up",
      latency: 31,
    ...
    },
    {
      id: "forgejo",
      name: "forgejo",
      blurb: "git, for the things that shouldn't be on github",
    ...
    },
    {
      id: "headscale",
      name: "headscale",
      blurb: "the mesh that stitches all of this together",
      who: "every machine on this page",
      host: "arrakis",
      health: "up",
      latency: 12,
      strip: strip(90, []),
    ...
    },
    {
      id: "matrix",
      name: "conduit",
      blurb: "matrix homeserver, for the group chat that left discord",
      who: "eleven people",
      host: "arrakis",
      health: "slow",
      latency: 612,
    ...
    },
    {
      id: "restic",
      name: "restic",
      blurb: "offsite backups of everything above, nightly",
      who: "future me",
      host: "giedi",
      health: "up",
      latency: 9,
    ...
    },
    {
      ...
      who: "the group chat, on weekends",
      host: "kaitain",
      health: "down",
      latency: 0,
